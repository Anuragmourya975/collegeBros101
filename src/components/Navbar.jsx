          ...
          <div className="flex-initial">
            <div className="flex justify-end items-center relative">
              <div className="flex mr-4 items-center">
                <a
                  className="inline-block py-2 px-3 bg-gray-200 hover:bg-gray-300 rounded-full"
                  href="#"
                  onClick={() => toggleModal()}
                >
                  <div className="flex items-center relative cursor-pointer font-medium whitespace-nowrap">
                    Add Resource
                  </div>
                </a>
